                                            ...
                                            <div class="tab-content">
                                                    ...
                                                    <div class="box">
                                                        ...
                                                        <div class="box-body">
                                                            <table id="example" class="table table-striped table-hover " style="width:100%">
                                                                ...
                                                                <tbody>
                                                                @forelse($periodos_rangos as $periodo_rango)
                                                                <tr>
                                                                    <th></th>
                                                                    <th></th>
                                                                    <th>{{$periodo_rango->nombre_rango}}</th>
                                                                    <th>{{$periodo_rango->duracion}}</th>
                                                                    <th>{{$periodo_rango->inicio}}</th>
                                                                    <th>{{$periodo_rango->fin}}</th>
                                                                    <th>{{$periodo_rango->nombre_periodo}}</th>
                                                                    <th></th>
                                                                </tr>
                                                                @empty
                                                ...
                                                <div class="tab-pane" id="tab_2">
                                                    <div class="box">
                                                        ...
                                                        <form action="{{route('app.range.save')}}" role="form" method="POST" id="FormRango">
                                                        @csrf
                                                            ...
                                                            <div class="box-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="Nombre" name="abreviacion" placeholder="Ingrese Nombre" required>
                                                                </div>
                                                                <div class="form-group">
