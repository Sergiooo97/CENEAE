...
<body>
    ...
    <div class="modal fade" id="modalReservar" tabindex="-1" role="dialog" aria-labelledby="modalReservar"
        ...
        <div class="modal-dialog modal-side modal-top-right" role="document">
            <div style="border-top-right-radius: 10px;border-radius: 10px;" class="modal-content">
                <div style="background: rgb(168, 47, 6); color:#ffffff;border-top-right-radius: 10px;border-top-left-radius: 10px;"
                    class="modal-header">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <a style="position: absolute; left: 70% !important; margin:0;" id="pro"
                                                href="#" class="btn btn-info ">Reservar</a>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <a style="position: absolute; left: 70% !important; margin:0;" href="#"
                                                class="btn btn-info ">Reservar</a>
                                        </div>
                                    </div>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark scrolling-navbar">
        <div class="container">
            ...
            <a class="button-link titlemontessori" data-scroll href="{{ route('montessori.index') }}"
                class="btn btn-danger" role="button" aria-pressed="true">MONTESSORI</a>
            ...
            @if (Route::has('login'))
                ...
                @auth
                    <a  class="button-link" href="{{ route('home') }}">Home</a>

                @else
                    <a class="button-link" href="{{ route('login') }}">INICIAR SESIÓN</a>

                    <!--@if (Route::has('register')) <a class="btn btn-outline-white btn-lg" href="{{ route('register') }}">Registrar</a> @endif --->
                @endauth
            @endif
            

            <button style="display:none !important" type="button" class=" button-link" data-toggle="modal"
                data-target="#basicExampleModal">
                <i class="nc-icon nc-pin-3 icon-maps"> </i>
            </button>
            <!-- Collapse -->
            <button style="display:none !important" class="navbar-toggler" type="button" data-toggle="collapse"
    ...
    <div id="inicio" class="view "
        style="background-image: url('../img/ntcd_blur.jpg'); background-repeat: no-repeat; background-size: cover; ">
        ...
        <div style="margin-top:5em;" class="container-fluid cotainer-logo-welcome">
            ...
            <div style="height:30%; padding:1em;" class="container-fluid flex-center">
                <img id="animated-img1 sun" class="animated bounce sun infinite" src="{!!  asset('img/sunlogo.png') !!}"
        ...
        <br>procurando que lleven una vida basada en la integridad personal y un estilo de vida saludable</strong>
                    ...
                    <div style="display: none; margin-top:17%;" class="aviso-inscripcion">
                        ...
                        <p class="info-inscripcion">Inscripciones para alumnos de primaria, hasta el 28 de septiembre.
                        </p>
    ...
    <main>
        ...
        <div class="container">
                ...
                <div class="row wow fadeIn">
                    <div class="col-lg-6 col-md-12 px-4 EAE-acerca">
                        ...
                        <div class="row EAE-acerca">
                            ...
                            <div class="col-10">
                                ...
                                <p class="grey-text">
                                    El niño es una esperanza y una promesa para la humanidad. Si la ayuda y la salvación
                                    han de llegar sólo puede ser a través de los niños,
                        ...
                        <div class="row EAE-acerca">
                            ...
                            <div class="col-10">
                                ...
                                <p class="grey-text">La educación busca formar al niño de manera integral: crecimiento
                                    físico, social, emocional y cognitivo. Además de ayudar al niño a ser un aprendiz
                                    independiente.
                            </div>
                        </div>
                        <!--/Third row-->
                    ...
                    <div class="col-lg-6 col-md-12">
                        ...
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe width="560" height="315" src="https://www.youtube.com/embed/TBC8JYwBwRk"
                                frameborder="0"
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="row EAE-acerca">
                            <div style="padding: 0;" class="col-6 mr-4">
                                ...
                                <p class="mision-vision">Somos una institución que empodera a nuestros estudiantes para
                                    que persistan en su pasión por el aprendizaje, contribuyendo en la formación de
                                    todos ellos mediante una educación cristiana de excelencia,
                                    procurando que lleven una vida basada en la integridad personal y un estilo de vida
                                    saludable dispuestos a servir a Dios y a la sociedad.
                                </p>
                            </div>
                            <div class="col-5">
                                <h3 class="h3 mb-3">VISIÓN</h3>
                                <p class="mision-vision">Ser una comunidad educativa, lider e innovadora que responde
                                    eficiente y eficazmente a las necesidades de nuestro entorno
                                    y el mundo globalizado, lo cual garantiza que su alumnado tendrá éxito en sus
                                    proyectos de vida.
                                </p>
                            </div>
                        </div>
                ...
                <div id="carousel-example-2" class="carousel slide carousel-fade" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            <div class="view">
                                <img class="d-block w-100" src="{{ asset('img/galeria/6.jpg') }}" alt="First slide">
                        ...
                        <div class="carousel-item">
                            <!--Mask color-->
                            <div class="view">
                                <img class="d-block w-100" src="{{ asset('img/galeria/1.jpg') }}" alt="Second slide">
                        ...
                        <div class="carousel-item">
                            <!--Mask color-->
                            <div class="view">
                                <img class="d-block w-100" src="{{ asset('img/galeria/3.jpg') }}" alt="Third slide">
                        ...
                        <div class="carousel-item">
                            <!--Mask color-->
                            <div class="view">
                                <img class="d-block w-100" src="{{ asset('img/galeria/8.jpg') }}" alt="Third slide">
                                <div class="mask rgba-black-slight"></div>
                            </div>
                            <div class="carousel-caption">
                                <h3 class="h3-responsive"></h3>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                        Integer sem libero, malesuada ut sem a, vehicula sodales lorem. Sed vel magna
                                        varius, venenatis ante eget, sagittis turpis. </p>
            ...
            <!--Section: Cards-->
            <div id="map"> </div>
            <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBLpNqK3zpnhjRHThUwv7y5e5cdD1VNEB4" async
                defer></script>
            <script>
                var map;
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <script
                            src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAhJeS1yPRBy7L69aacRlO-lCNXdoKC6OE">
                        </script>
                        <script>
        ...
        <div id="map"> </div>
        <script
            src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAhJeS1yPRBy7L69aacRlO-lCNXdoKC6OE&callback=initMap"
            async defer></script>
        <script>
            var map;
