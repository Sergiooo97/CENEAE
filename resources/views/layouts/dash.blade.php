...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('dash/css/bootstrapValidator.css') }}">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.5.0/css/font-awesome.min.css">
    <!-- Ionicons -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/ionicons/2.0.1/css/ionicons.min.css">
    <!-- Select2 -->
    <link rel="stylesheet" href="{{ asset('dash/plugins/select2/select2.min.css') }}">
    <!-- PNotify -->
    <link href="{{asset('dash/js/pnotify/pnotify.custom.min.css')}}" rel="stylesheet">
    <!-- Theme style -->
    ...
    <link rel="stylesheet" href="{{ asset('dash/css/skin-blue.min.css') }}">
        ...
        <nav class="navbar navbar-static-top" role="navigation">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-left">
                                    <a onclick="event.preventDefault();document.getElementById('salir-form').submit();" class="btn btn-default btn-flat btn-salir">Salir</a>
                                    <form  method="POST" style="display: none;" id="salir-form">
                                        {{ csrf_field() }}
                                    </form>
                                </div>
                            </li>
            ...
            <!-- Left side column. contains the logo and sidebar -->
                    <aside class="main-sidebar">
                        ...
                        <section class="sidebar">
                            ...
                            <ul class="sidebar-menu">
                                ...
                                <li class="active"><a href="{{ route('home') }}"><i class="fa fa-tachometer"></i> <span>Dashboard</span></a></li>
                                <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                                ...
                                <li><a ><i class="fa fa-book"></i> <span>Cursos</span></a></li>
                                <li><a ><i class="fa fa-child"></i> <span>Alumnos</span></a></li>
                                <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                                ...
                                <li><a><i class="fa fa-users"></i> <span>Usuarios</span></a></li>
                            </ul>
                            <!-- /.sidebar-menu -->
                        </section>
                        <!-- /.sidebar -->
            ...
            <!-- REQUIRED JS SCRIPTS -->
            <script src="{{ asset('dash/js/jquery-3.2.1.min.js') }}"></script>
            <!-- Bootstrap 3.3.6 -->
            <script src="{{ asset('dash/js/bootstrap.min.js') }}"></script>
            <!--Bootstrap-->
            <script src="{{ asset('dash/plugins/validator/bootstrapValidator.min.js') }}"></script>
            <!--Slim scroll-->
            ...
            <!-- Select2 -->
            <script src="{{ asset('dash/plugins/select2/select2.full.min.js') }}"></script>
            <!-- PNotify -->
            <script src="{{asset('dash/js/pnotify/pnotify.custom.min.js')}}"></script>

            <!--serialize-->
            <script src="{{ asset('dash/js/jquery.serializeObject.min.js') }}"></script>
            <!-- DataTables -->
            ...
            <!--Excel-->
            <script src="{{ asset('dash/js/jquery.btechco.excelexport.js') }}"></script>
            <script src="{{ asset('dash/js/jquery.base64.js') }}"></script>
            <!-- AdminLTE App -->
            ...
            <script src="{{ asset('dash/js/index.js') }}"></script>
@yield('scripts')
